...
find $1 -type f -not -name "*.sh" -exec sed -i 's/\[EXTENSION_NAME\]/JG Auth/g' {} \;
find $1 -type f -not -name "*.sh" -exec sed -i 's/\[PACKAGE_NAME\]/JG Auth/g' {} \;
find $1 -type f -not -name "*.sh" -exec sed -i 's/\[PROJECT_NAME]/JG Auth/g' {} \;
...
find $1 -type f -not -name "*.sh" -exec sed -i 's/com_jgauth/com_jgauth/g' {} \;
find $1 -type f -not -name "*.sh" -exec sed -i 's/COM_FOO/COM_JGAUTH/g' {} \;
