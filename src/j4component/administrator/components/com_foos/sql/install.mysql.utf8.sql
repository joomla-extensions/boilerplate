CREATE TABLE IF NOT EXISTS `#__joomlathings_details` (
...
INSERT INTO `#__joomlathings_details` (`name`) VALUES
('Nina'),
('Astrid'),
('Elmar');
...
ALTER TABLE `#__joomlathings_details` ADD COLUMN  `ordering` int(11) NOT NULL DEFAULT 0 AFTER `alias`;

ALTER TABLE `#__joomlathings_details` ADD COLUMN  `params` text NOT NULL AFTER `alias`;
